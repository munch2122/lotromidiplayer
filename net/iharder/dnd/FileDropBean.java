...
public class FileDropBean implements java.io.Serializable {
	 ...
	 * then all elements contained within will also be registered as drop
	 * targets, though only the outer container will change borders during a
	 * drag and drop operation (and even then, only if the container is a Swing
	 * component).
	 * 
	 * @param comp
